...
using Xtreem.CryptoPrediction.Service.Exceptions;
...
namespace Xtreem.CryptoPrediction.Service.Services
{
    ...
    {
        private readonly KlineMappingService _klineMappingService;
        private BinanceSocketClient _socketClient;

        public BinanceService(KlineMappingService klineMappingService)
        {
